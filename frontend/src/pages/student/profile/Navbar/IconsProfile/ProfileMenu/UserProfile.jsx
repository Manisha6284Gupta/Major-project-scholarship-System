...
//         <div
//           key={key}
//           className="border rounded-lg p-4 text-center text-gray-500 bg-gray-50 shadow-sm"
//         >
//           <p className="font-medium mb-2">{label}</p>
//           <p className="text-sm italic">Not Uploaded</p>
//         </div>
...
//   return (
//     <div ref={profileRef} className="max-w-6xl mx-auto mt-6 px-4 pb-10">
//       {/* Profile Header */}
//       <div className="bg-white shadow-md rounded-xl p-6 mb-6 flex flex-col sm:flex-row justify-between items-center gap-6">
//         <div className="flex items-center gap-5">
//           <img
//             src={getFileURL(user?.photo?.[0]) || "https://via.placeholder.com/150"}
//             alt="Profile"
...
//             <p className="text-gray-600">Roll No: {user?.rollNo || "N/A"}</p>
//             <p className="text-sm text-gray-500">
//               {user?.branch || "N/A"} | {user?.course || "N/A"}
//             </p>
//           </div>
//         </div>
...
//             "Mother's Name": user.motherName,
//             "Parent Contact": user.parentContact,
//             "Occupation": user.parentOccupation,
//             "Annual Income": user.parentIncome
//               ? `₹${user.parentIncome}`
//               : "N/A",
//           }}
